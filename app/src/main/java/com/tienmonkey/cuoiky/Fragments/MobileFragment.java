...
public class MobileFragment extends Fragment {
    ...
    private static final String ARG_PARAM1 = MobileFragment.class.getSimpleName();
...
//        imMenu = view.findViewById(R.id.imMenu);
        ...
        productRef = FirebaseDatabase.getInstance().getReference().child("Products").orderByChild("category").equalTo("mobile");
